...
write = xlsxwriter.Workbook('D:/大数/规整后/轴距.xlsx')
sheet1 = write.add_worksheet('轴距')
print('郭睿')
# ---------------------------methods---------------
def resymbol(str):
...
M = pd.read_excel('D:/大数/原始值/轴距.xlsx', usecols=[0])
M = M.sort_values(by='轴距')
...
# indecs.loc[0] = '-'
indecs = pd.read_excel('D:/大数/index/轴距.xlsx')
indecs = indecs['indecs']
...
# # -------------------------查之前存在的xlsx文件
# indecs.to_excel('D:/大数/index/轴距.xlsx')
