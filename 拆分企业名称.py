...
#         temp = re.sub('\\(\d*.*?\\)','',temp)
#         temp = re.sub('C.*?\\)','',temp)
#         temp = re.sub('\d.*?R20','',temp)
#         temp = re.sub('\d.*?R20\\(','',temp)
#         temp = re.sub('\d.*?R22.5\\(','',temp)
#         temp = re.sub('\d.*?R22.5\\:','',temp)
#         temp = re.sub('\d.*?R','',temp)    
#         temp = re.sub('\d.*?\\/.*?R','',temp)
...
for i in range(0, len(EN4)):
    ...
    if len(EN4[i][start:len(EN4[i])]) > 1:
        sheet4.write(i, 1, EN4[i][start:len(EN4[i])])
        sheet4.write(i, 2, '0')
        row += 1
