...
write = xlsxwriter.Workbook('D:/大数/规整后/轴数.xlsx')
sheet1 = write.add_worksheet('轴数')
print('郭睿')
# ---------------------------methods---------------
def resymbol(str):
...
M = pd.read_excel('D:/大数/原始值/轴数.xlsx', usecols=[0])
M = M.sort_values(by='轴数')
...
# indecs.loc[0] = '-'
indecs = pd.read_excel('D:/大数/index/轴数.xlsx')
indecs = indecs['indecs']
...
# # -------------------------查之前存在的xlsx文件
# indecs.to_excel('D:/大数/index/轴数.xlsx')
